...
import CreateAccidents from './CreateAccidents'
...
export default function TableSort() {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get('http://localhost:9000/api/services/accidents', {
                headers: {
    ...
    const handleChangeCondition = async (id) => {
        try {
            const response = await axios.put(`http://localhost:9000/api/services/accidents/status/${id}`, {}, {
                headers: {
                    Authorization: 'Bearer ' + adminInfo.token,
                },
            });
    ...
    return (
        <Container size="xl" style={{ paddingTop: '20px' }}>
            ...
            <CreateAccidents adminInfo={adminInfo} fetchData={fetchData} />
