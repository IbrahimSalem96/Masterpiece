        ...
        <>
            <div className="container-fluid px-4">
                ...
                <div className="row">
                    ...
                    <CountPost adminInfo={adminInfo} />

                    <BookCars adminInfo={adminInfo} />
                </div>
                <div className="row">
                    ...
                    <div className="col-xl-6">
                        <div className="card mb-4">
                            ...
                            <div className="card-body">
                                <ChartServices adminInfo={adminInfo} />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-xl-12">
                        <div className="card mb-4">
                            ...
                            <div className="card-body d-flex justify-content-center" style={{ width: '800px', height: '800px' }}>
                                <ChartOverallPerformance adminInfo={adminInfo} />
                            </div>
                        </div>    ;
                    </div>
