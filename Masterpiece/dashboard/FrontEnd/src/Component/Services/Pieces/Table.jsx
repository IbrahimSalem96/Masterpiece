...
import CreatePiecesl from './CreatePiecesl'
...
export default function TableSort() {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get('http://localhost:9000/api/services/location-pieces/', {
                headers: {
    ...
    const handleChangeCondition = async (id) => {
        try {
            const response = await axios.put(`http://localhost:9000/api/services/location-pieces/status/${id}`, {}, {
                headers: {
                    Authorization: 'Bearer ' + adminInfo.token,
                },
            });
    ...
    return (
        <Container size="xl" style={{ paddingTop: '20px' }}>
            ...
            <CreatePiecesl adminInfo={adminInfo} fetchData={fetchData} />
            ...
            <ScrollArea>
                ...
                />
                <Table horizontalSpacing="md" verticalSpacing="xs" w={1100} sx={{ tableLayout: 'scroll' }}>
                    <thead>
                        <tr>
