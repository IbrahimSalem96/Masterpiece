...
function Edit({ editId, adminInfo, fetchData }) {
    ...
    const handleEdit = async () => {
        try {
            const response = await axios.put(`http://localhost:9000/api/services/maintenance-request/${editId}`, fields, {
                headers: {
            ...
            <div className="modal-dialog modal-lg">
                <div className="modal-content">
                    <div className="modal-header">
                        <h1 className="modal-title fs-5" id="exampleModalLabel">Edit Maintenance</h1>
