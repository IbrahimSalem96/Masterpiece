...
function Delete({ deleteId, adminInfo, fetchData }) {
    ...
    const deleteAdmin = async () => {
        try {
            const response = await axios.delete(`http://localhost:9000/api/scrap/auction-service/${deleteId}`, {
                headers: {
                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h1 className="modal-title fs-5" id="exampleModalLabel">Delete Scrap Auction </h1>
