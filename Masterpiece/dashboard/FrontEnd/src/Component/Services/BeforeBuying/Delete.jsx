...
function Delete({ deleteId, adminInfo, fetchData }) {
    ...
    const deleteAdmin = async () => {
        try {
            const response = await axios.delete(`http://localhost:9000/api/services/before-buying/${deleteId}`, {
                headers: {
                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h1 className="modal-title fs-5" id="exampleModalLabel">Delete Before Buying</h1>
